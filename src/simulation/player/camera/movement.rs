use crate::{
    simulation::chunk::ChunkCoord,
    simulation::input::{ActionStateResource, types::simulation_action::SimulationAction},
    simulation::player::{ActiveCamera, CameraComponent},
    simulation::time::FrameClock,
};
