...
use crate::ecs_core::config::AppConfig;
use crate::render::textures::{BlockTextureArray, load_voxel_texture_assets};
use crate::simulation::app_lifecycle::AppLifecyclePlugin;
use crate::simulation::block::BlockRegistryResource;
use crate::simulation::{
    asset_management::AssetManagementPlugin, biome::BiomePlugin, block::BlockPlugin,
    chunk::ChunkLoadingPlugin, input::InputModulePlugin, player::PlayerPlugin,
    showcase::ShowcasePlugin, terrain::TerrainGenerationPlugin, time::TimeControlPlugin,
};
