use crate::{
    render::passes::{
        ChunkStorageManager, VoxelMesh, gpu_resources::world_uniforms::ChunkStorageBindGroupLayout,
    },
    simulation::chunk::meshing::common::{AoLevel, FaceSide},
};
use bevy::{
    reflect::Reflect,
...
pub fn upload_voxel_mesh(
    ...
    manager.allocate_chunk(device, queue, layout, faces, world_pos)
}
